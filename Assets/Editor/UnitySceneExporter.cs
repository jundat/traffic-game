...
/*=============================================================================
 ...
 |       Author:  aaro4130
 |
 |   Known Bugs:  Sometimes default primitives don't come out correctly
 |
...
public class UnitySceneExporter : ScriptableWizard {
	
	[MenuItem ("Export/To OBJ...")]
	static void CreateWizard()
	{
		ScriptableWizard.DisplayWizard("Export OBJ", typeof(UnitySceneExporter),"Export");
	}
